...
enum {
    ...
    CLOCK_DOMAIN_BITM_RTP_RX     = 0x00000100u,
    CLOCK_DOMAIN_BITM_RTP_TX     = 0x00000200u,
    CLOCK_DOMAIN_BITM_SPDIF_IN   = 0x00000400u,
    CLOCK_DOMAIN_BITM_SPDIF_OUT  = 0x00000800u,
    CLOCK_DOMAIN_BITM_VBAN_RX    = 0x00001000u,
    CLOCK_DOMAIN_BITM_VBAN_TX    = 0x00002000u,
    CLOCK_DOMAIN_BITM_FILE_SRC   = 0x00004000u,
    CLOCK_DOMAIN_BITM_FILE_SINK  = 0x00008000u,
    CLOCK_DOMAIN_BITM_MIC_IN     = 0x00010000u,
};
